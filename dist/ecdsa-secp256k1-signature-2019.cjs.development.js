...
var ecdsaSecp256k1VerificationKey2019 = require('@bloomprotocol/ecdsa-secp256k1-verification-key-2019');
...
class EcdsaSecp256k1Signature2019 extends jsigs.suites.LinkedDataSignature {
  constructor(options = {}) {
    super({
      ...
      LDKeyClass: ecdsaSecp256k1VerificationKey2019.EcdsaSecp256k1VerificationKey2019,
      contextUrl: SUITE_CONTEXT_URL,
      ...options
    });
...
//# sourceMappingURL=ecdsa-secp256k1-signature-2019.cjs.development.js.map
